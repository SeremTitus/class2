...
Partial Class MDIParent1
    ...
    Private Sub InitializeComponent()
        ...
        ' 
        NewToolStripMenuItem.DropDownItems.AddRange(New ToolStripItem() {RegistrationToolStripMenuItem, AccountsToolStripMenuItem, CourseToolStripMenuItem})
